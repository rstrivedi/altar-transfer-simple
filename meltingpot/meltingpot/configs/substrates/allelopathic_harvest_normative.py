...
"""Configuration for Allelopathic Harvest with Normative Sanctioning.

Added by RST: This is the normative variant of allelopathic harvest.

This substrate extends allelopathic harvest with institutional sanctioning:
- Violation = body_color != altar_color (after grace period)
- Sanctioning via zap beams with rewards:
  * costForSanctioning (c): -0.2
  * penaltyForSanctioned: -10
  * rewardForCorrectSanctioning (alpha): +0.5
  * penaltyForMisSanctioning (beta): -0.5
- Immunity system: 200 frames after sanction, clears on color change or timeout
- Tie-break mechanism: prevents simultaneous sanctions on same target
- ALTAR observation exposes altar color to agents

Based on allelopathic harvest substrate.
"""
      ...
      "components": [
          ...
          },
          {
              ...
              "kwargs": {
                  ...
                  # Added by RST: SimpleZapSanctioning handles removal instead of Zapper.
          ...
          # Added by RST: Altar observation for normative sanctioning
          {
...
def create_scene(num_players: int):
  ...
  scene = {
      ...
      "components": [
          ...
          # Added by RST: Normative sanctioning components
          {
              "component": "Altar",
              "kwargs": {
...
def get_config():
  """Default configuration for the allelopathic harvest normative level."""
  ...
  # Added by RST: Add ALTAR observation for normative sanctioning
